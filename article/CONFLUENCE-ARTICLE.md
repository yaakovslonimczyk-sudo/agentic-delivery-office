...
## How to run AI sub-agents like a consulting firm — and why the org chart matters more than the prompts

*By Yaakov Slonimczyk — Solution Architect · shared internally as a starting point for discussion*

---

> ⚠️ **BETA — personal open-source side project.** This is something I built and maintain on my own time. It is shared here **as-is, for anyone curious to experiment** — it is **not an official or supported Payoneer tool**, has no SLA, and will have rough edges. Feedback is very welcome (comment below or ping me on Teams). *Convert this blockquote to a Confluence **Warning** panel once pasted — see the publish guide.*

---

![The office, mid-match — the live board rendered as a 4-3-3](https://raw.githubusercontent.com/yaakovslonimczyk-sudo/agentic-delivery-office/main/article/images/match-demo.gif)

*The Agentic Delivery Office, live: a pass out wide, a goal at Gate 1, a VAR check on a regression. The same telemetry that runs the methodology, rendered as a football match. More on why below.*
...
![What crosses the boundary](https://raw.githubusercontent.com/yaakovslonimczyk-sudo/agentic-delivery-office/main/article/images/fig05-context-isolation.png)
...
![The org chart](https://raw.githubusercontent.com/yaakovslonimczyk-sudo/agentic-delivery-office/main/article/images/fig01-org-chart.png)
...
![Three gates](https://raw.githubusercontent.com/yaakovslonimczyk-sudo/agentic-delivery-office/main/article/images/fig02-three-gates.png)
...
![The review-fix loop](https://raw.githubusercontent.com/yaakovslonimczyk-sudo/agentic-delivery-office/main/article/images/fig03-review-loop.png)
...
![Model routing](https://raw.githubusercontent.com/yaakovslonimczyk-sudo/agentic-delivery-office/main/article/images/fig04-model-routing.png)
...
![The live board](https://raw.githubusercontent.com/yaakovslonimczyk-sudo/agentic-delivery-office/main/article/images/fig06-cockpit-live-board.png)
...
![Gate 1 as a screen](https://raw.githubusercontent.com/yaakovslonimczyk-sudo/agentic-delivery-office/main/article/images/fig07-cockpit-gate1.png)
...
![The match view](https://raw.githubusercontent.com/yaakovslonimczyk-sudo/agentic-delivery-office/main/article/images/fig09-match-broadcast.png)
...
*(The animated version of this is the hero clip at the top of the page.)*
...
![The economics](https://raw.githubusercontent.com/yaakovslonimczyk-sudo/agentic-delivery-office/main/article/images/fig10-economics.png)
...
It installs once at user scope — agents, protocol, Live Board, and the `/office-init` / `/office-board` commands become available everywhere — but it stays **opt-in per project**: dormant until you run `/office-init` in a repo, so it never imposes gates on the throwaway script or the side project. Enroll a repo, give it its business context, and put one real feature through the gates before trusting the office unattended. It's portable, too — the same roster and protocol install for OpenAI Codex and Grok.

**This is an early beta and I'm genuinely after feedback** — what's confusing, what you'd cut, where it breaks on a real codebase. Drop a comment on this page, open an issue on the repo, or ping me on Teams. If you want to argue with the org chart, even better.

---

*Reminder: personal open-source side project, MIT-licensed, shared as-is — not an official Payoneer tool. — Yaakov*
